...
class GridChara (val listHeroes: ArrayList<Chara>): RecyclerView.Adapter<GridChara.GridViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): GridViewHolder {
        val view: View = LayoutInflater.from(viewGroup.context).inflate(R.layout.grid_chara, viewGroup, false)
